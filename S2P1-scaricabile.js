...
console.log(" esercizio 11, iterare da 0 a 15");
...
if (numIntero1 === 8 || numIntero2 === 8 || numIntero1 + numIntero2 === 8 || numIntero1 - numIntero2 === 8) {
    console.log("true");
} else {  
    console.log("false");
}           
...
let totalShoppingCart2 = parseInt(prompt("Inserisci il totale del carrello:"));

totalShoppingCart2 = totalShoppingCart2 - ((totalShoppingCart2 * 20) / 100);
...
console.log("Il tuo genere è:", gender);
